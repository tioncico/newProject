...
{
	/**
	 * @Api(name="add",path="/Api/Common/ArticleCategory/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/ArticleCategory/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/ArticleCategory/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/ArticleCategory/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/ArticleCategory/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
